...
export default function FeedbackComponent({
  ...
  const [error, action] = useFormState(addFeedback, {});

  const [name, setName] = useState<string | undefined>(feedback?.fullName);
  const [email, setEmail] = useState<string | undefined>(feedback?.emailF);

      ...
      <div className="container p-6 mx-auto">
          ...
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <div className="flex mt-6 -mx-2">
                <a
                  href="#"
                  className="mx-2 transition-colors duration-300 text-white hover:text-customRed"
                  aria-label="Reddit"
                >
                  <svg
                ...
                <a
                  href="#"
                  className="mx-2 text-white transition-colors duration-300 hover:text-customRed"
                  aria-label="Facebook"
                >
                  <svg
                    className="w-5 h-5 fill-current"
        ...
        <div>
          <p className="text-center text-white">
            © PrefCart 2024 - All rights reserved
          </p>
        </div>
      </div>
    </footer>
